...
From the selected model, we can observe that the player's position decides the value of the y-intercept. If the player is a Defender, his prediction formula constant would be 15.9 million euro. If the player is a Forward, his prediction formula constant would be -0.607 million euro. If the player is a Goalkeeper, his prediction formula constant would be 22.7 million euro. And lastly, if the player is a Midfielder, his prediction formula constant would be 19.6 million. We found that for every additional match a player appears at, his market value would generally increases by 0.406 million euro, for every additional goal scored, his market value would generally increase by 2.02 million euro, and for every additional goal assisted, his market value would generally increase by 0.885 million euro. Players aged between 21 to 25 are 3.66 million euro more valuable than players below 20 years old, players aged between 26 and 30 are 9.07 million euro more valuable than players below 20 years old, and players above 30-year-old are 0.366 million euro less valuable than players below 20 years old. 
Additionally, we have taken the interactions between position/goals and position/assists into account. On average, every goal scored can increase a Forward's market value by 0.937 million euro, while every goal can get a midfilder 1.45 million euro decrease in market value. Every assist can get a forward 2.74 million euro increase in market value; Every assist can get a goalkeeper 23.4 million euro increase in market value; However, every assist can get a midfielder 0.366 million euro decrease in market value.
...
```{r fitting_the_model}
players1 <- players1 %>%
  mutate(predicted_value = predict(selected_model, players1)) %>%
  select(name, market_value, predicted_value)
glimpse(players1)
```
=======
>>>>>>> 5e6b0c685b23d9b5b7e612944cc78b13ed98d44a
