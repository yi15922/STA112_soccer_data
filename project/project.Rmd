...
The boxplot also revaled that there are many outliers in the data. The table below shows the names and market values of the outlying soccer players: 
...
These players have extremely high market values compared to the rest of the players. Which raises the question: do they perform much better than the other players? Let's compare the number of goals they scored to the number of goals players with "normal" market values scored: 
