...
The AIC value is lower compared to the full model (`r glance(linear_prediction)$AIC` to `r glance(selected_model)$AIC`), which means that the new model is more accurate.
