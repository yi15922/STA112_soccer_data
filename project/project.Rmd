...
After the model selection based on AIC, we can see that the new model has reduced the significant variables down to 15; variables "age", "own_goals", "yellow_cards", "red_cards", "substituted_on", "substituted_off", and "age_range20 and below" have been eliminated.
...
For Defenders :
The estimated y-intercept for a defender is 15.9 million euro. Defenders' market values will increase if attending more matches and getting more goals and assists (though assists and goals are relatively unusual stuff for defenders). Also, 26-30 is the golden age range for a defender.

For Goalkeepers : 
The estimated y-intercept for a goalkeeper is 38.6 million euro. Goalkeepers' market values will increase if attending more matches, aging between 26 and 30. Although we can observe a very high coefficient for assists, we are not taking it into account because only one goalkeeper in the dataset has made one assist. Besides being not typical, it's commonsense that it's never a goalkeeper's responsibility to rush into the opponent's box to score a goal or make an assist.

For Midfielders : 
The estimated y-intercept for a midfielder is 38.6 million euro. Midfielders' market values will increase if attending more matches, aging between 26 and 30, and getting more goals and assists. Here it's reasonable for midfielders to have lower coefficients for goals and assists compared to defenders, because usually midfielders perform better in these statistics.

For Forwards : 
The estimated y-intercept for a forward is 15.293 million euro. Forwards' market values will increase if attending more matches and getting more goals and assists. Still, the golden age of a forward is between 26 and 30.
