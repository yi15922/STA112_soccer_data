...
The resulting histogram does not provide any additional insights, therefore we will discard it and use the original data in the following discussion.

In the Figure 1, we can see that the distribution of the players' market values in the 2018-2019 season is right-skewed, and that the most commonly occuring market value is around $23 million. In the summary statistics below, we can see that the mean of the market values is higher than the most commonly occuring market values due to the right skewedness of the data: 
